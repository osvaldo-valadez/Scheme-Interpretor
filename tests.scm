...
(quote (1 (apply + '(1 2))))
; expect (1 (apply + (quote (1 2))))

(and 0 (* (+ 6 90) 4) (< 5 0) (/ (*5 6) 0))
; expect #f

(and (equal? True #t) (equal? False #f))
; expect #t

(cond ((equal? (or) #t) 'I) ((equal? (and) #f) 'said) (else 'young-man) )
; expect young-man

(print (begin 'never 'going 'to 'give 'you 'up))
; expect up

'('you '('are '('my '(' fire))))
; expect ((quote you) (quote ((quote are) (quote ((quote my) (quote ((quote fire))))))))
